...
{
	public class AdjustRWEventsIntegration : MonoBehaviour
	{
		[CompilerGenerated]
		...
		private void OnRewardedVideoReceivedRewardCallback(string s)
		{
		}

		private void SendRWEventsNextFrame()
		{
		}
