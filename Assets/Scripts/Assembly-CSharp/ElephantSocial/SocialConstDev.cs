namespace ElephantSocial
{
	public class SocialConstDev
	{
		...
		public static string UpdateTeamStatEp { get; }

		public static string UpdatePlayerStatEp { get; }

		public static string TeamTopStatEp { get; }

		public static string PlayerTopStatEp { get; }

		public static string GetInboxEp { get; }

		public static string InboxReadEp { get; }

		public static string ReportURL { get; }

		public static string TeamCoopEventEp { get; }

		public static string TeamCoopEventIncrementEp { get; }

		public static string TeamCoopEventSetClaimedEp { get; }

		public static string TeamCoopEventCheckRewardsEp { get; }

		public static string TeamWarEp { get; }

		public static string TeamWarStateEp { get; }

		public static string TeamWarRankingEp { get; }

		public static string TeamWarPhaseRankingEp { get; }

		public static string TeamWarAddScoreEp { get; }
